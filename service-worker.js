const CACHE_NAME = 'tattoolab-v5a';
const ASSETS = ['./','./index.html','./manifest.json','./assets/mask_square.png','./assets/mask_splat.png','./icons/icon-64.png','./icons/icon-192.png','./icons/icon-512.png'];
